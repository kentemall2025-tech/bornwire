...
export const showcaseContent = [
  {
    id: "2",
    imageurl:
      "https://csmvkgdme8w3hyot.public.blob.vercel-storage.com/WhatsApp Image 2025-11-11 at 12.41.37 PM (3).jpeg",
    description:
  ...
  },
  {
    id: "4",
    imageurl:
      "https://csmvkgdme8w3hyot.public.blob.vercel-storage.com/ddf60025-df47-406f-83e4-355b36924db5.jpg",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempore, magnam ipsam? Illum, iste et. Aliquid, animi aspernatur? Quisquam, dolorem eveniet.",
  },
  {
...
export const servicesContent = [
  {
    ...
    message:
      "We deliver to over 200+ countries in the world.We aid you finding a delivery agent here, that matches yor budget .We are online anytime, everytime to serve you with the best of quality. 24/7. call or reach out to us to get your piece.",
  },
  {
    icon: Server,
    title: "Online Services",
    message:
      "We always here to aid you in your search for authentic cultural experience online.We think culture is for the royalties of which you are a part. We here to serve you. You are a few clicks away from becoming a royalty .",
  },
  {
    icon: HeartHandshake,
    title: "More Services",
